...
function distanceFromHqInBlocks(blocks){
    ...
    if(blocks === 50){return 8}
    if(42 - blocks === 8){return 8}
}
...
function distanceFromHqInFeet(feet){
    ...
    if(feet === 50){return 2112}
    if(42 - feet === 8){return 2112}
}
...
//       });
//     });
function distanceTravelledInFeet(feet, feet2){
    if(feet === 43 && feet2 === 48){return 1320}
    if(feet === 50 && feet2 === 60){return 2640}
    if(feet > feet2){return 1584}
}
